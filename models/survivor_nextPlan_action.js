...
const survivorNextPlanActionSchema = new mongoose.Schema({
    survivor: {
    ...
    select:{
        type:String,
        enum:{
            values:["PC","VC","Rehab","Advocacy Traning","FIR","ChargeSheet","Investigation"],
            message:'{VALUE} is not a correct value. Expected PC,VC,Rehab,Advocacy Traning,FIR,ChargeSheet'
        }
    },
    mode_of_meeting:{
        type:String,
...
const SurvivorNextplanAction = new mongoose.model("SurvivorNextplanActions",survivorNextPlanActionSchema);

module.exports = SurvivorNextplanAction;